...
_EXTRA_COLUMNS: list[dict[str, Any]] = [
    ...
    {"title": "connection_message", "uidt": "LongText"},
    {"title": "followup_message", "uidt": "LongText"},
    {
        "title": "mensaje_estado",
        "uidt": "SingleSelect",
        "options": [
            {"title": "Sin mensaje", "color": "#6c757d"},
            {"title": "Pendiente confirmar", "color": "#f59e0b"},
            {"title": "Confirmado", "color": "#10b981"},
            {"title": "Enviado", "color": "#2563eb"},
        ],
    },
]
