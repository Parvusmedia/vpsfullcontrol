...
const I18N = {
  en: {
    ...
    "hub.badge1": "🇪🇸 Spain-first",
    "hub.badge2": "Free demo",
    "hub.badge3": "No credit card",
    "hub.title": "B2B data enrichment for growth teams",
    "hub.lede":
      "Companies for paid media audiences. Sales Navigator for outbound CSVs. Same quality bar, two workflows.",
    ...
    "hub.companies.stat": "~20s",
    "hub.companies.statLabel": "avg. resolve time",
    "hub.companies.body":
  ...
  es: {
    ...
    "hub.badge1": "🇪🇸 España primero",
    "hub.badge2": "Demo gratis",
    "hub.badge3": "Sin tarjeta",
    "hub.title": "Enriquecimiento B2B para equipos de crecimiento",
    "hub.lede":
      "Companies para audiencias de paid media. Sales Navigator para CSVs de outbound. Misma calidad, dos flujos de trabajo.",
    ...
    "hub.companies.title": "Paid Media Audiences",
    "hub.companies.stat": "~20s",
    "hub.companies.statLabel": "tiempo medio de resolución",
    "hub.companies.body":
