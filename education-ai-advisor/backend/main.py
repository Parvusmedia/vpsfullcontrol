...
FRONTEND = os.getenv("EDU_FRONTEND_DIR", "")

app = FastAPI(title="Education AI Student Advisor", version="1.0.0", docs_url=None, redoc_url=None)
...
def recommend(body: RecommendIn) -> dict[str, Any]:
    try:
        ...
        return {
            ...
            "fallback": True,
            "message": "We will help you find the right programme.",
            "explore_url": "https://educationdemo.pmediaplus.com/admin",
            "best": None,
            "alternatives": [],
        }
...
def question(body: QuestionIn) -> dict[str, Any]:
    try:
        ...
        return {
            "answer": "An advisor can help you. I only use the approved catalogue.",
            "source": "fallback",
        }
