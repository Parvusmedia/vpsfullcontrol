...
def build_sme_inmail_message(lead: dict[str, Any]) -> str:
    ...
    if use_spanish_outreach(lead):
        return (
            ...
            f"Te contacto para pedirte si podrías indicarme qué persona o área debería contactar dentro de {brand}.\n\n"
            f"Trabajo con automatización, data driven, AI y desarrollo de nuevas soluciones, y llevo más de 20 años "
            f"entre negocio y tecnología. He trabajado con empresas como Telefónica, Grupo Havas, WPP y otras, y en "
            f"muchos casos me encuentro con equipos de empresas como {brand}.\n\n"
            f"Lo que me gustaría explorar es colaborar como consultor o especialista externo, integrándome con "
            f"vuestros equipos cuando mi experiencia pueda aportar valor.\n\n"
            f"Si tiene sentido, encantado de contarte brevemente lo que hago y, sobre todo, saber con quién debería "
            f"hablar dentro de {brand}.\n\n"
            f"Muchas gracias,\nEmiliano"
        )
    return (
        f"Hi {first}, nice to meet you.\n\n"
        f"I'm reaching out to ask if you could point me to the right person or team at {brand}.\n\n"
        f"I work on automation, data-driven marketing, AI and building new solutions — 20+ years between business and "
        f"technology. I've worked with companies like Telefónica, Havas, WPP and others, and I often come across "
        f"teams like yours at {brand}.\n\n"
        f"What I'd like to explore is collaborating as an external consultant or specialist, joining your teams when "
        f"my experience can add value.\n\n"
        f"If it makes sense, I'd be glad to tell you briefly what I do — and especially who I should speak with "
        f"inside {brand}.\n\n"
        f"Thank you,\nEmiliano"
    )
