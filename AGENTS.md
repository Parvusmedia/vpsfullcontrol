...
`list` no devuelve secretos. `get` escribe el valor a un archivo 0600. Nunca echo de tokens en chat, commits o logs. Detalle: [`docs/ACCESOS_NOCO.md`](docs/ACCESOS_NOCO.md).
