(function (root) {
  ...
  var STEPS = [
    ...
    },
    {
      ...
      num: "1",
      title: "Anuncio",
      hint: "Creativos IAB con el wizard"
    },
    {
      id: "orientador",
      href: "/",
  ...
  function renderDemoGuide(active) {
    return (
      ...
      "<li><span class=\"flow-num\">1</span><span><b>Anuncio</b> — formatos 300×600 y 970×250; el usuario responde 3 preguntas y llega a WhatsApp o deja datos.</span></li>" +
  ...
  function hereBanner(active) {
    var labels = {
      ...
      anuncio: "Estás en el <b>Anuncio</b> (paso 1). Completa el wizard en el banner y sigue con el <a href=\"/\">Orientador</a>.",
